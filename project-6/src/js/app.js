App = {
    ...
    originMakerID: "0x0000000000000000000000000000000000000000",
    ...
    readForm: function () {
        ...
        App.originMakerID = $("#originMakerID").val();
    ...
    handleButtonClick: async function(event) {
        ...
        switch(processId) {
            case 1:
                return await App.researchItem(event);
                break;
            case 2:
    ...
    researchItem: function(event) {
        event.preventDefault();
        var processId = parseInt($(event.target).data('id'));

        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.researchItem(
                App.upc, 
            ...
            console.log('researchItem',result);
        }).catch(function(err) {
